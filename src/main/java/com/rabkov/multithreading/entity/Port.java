...
public class Port {
    ...
    public Pier getPier() throws MultiException {
        try {
            pierLock.lock();
            while (freePiers.isEmpty()) {
                try {
                    ...
                    throw new MultiException("Thread was interrupted", e);
                }
            }
    ...
    public void loadShip(Ship ship) throws MultiException {
        try {
            shipLock.lock();
            while(!ship.isFull()) {
    ...
    public void unloadShip(Ship ship) throws MultiException {
        try{
            shipLock.lock();
            while(!ship.isEmpty()){
